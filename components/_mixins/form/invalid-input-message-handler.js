...
export const InvalidInputMessageHandler = {
    ...
    methods: {
        ...
        invalidInputMessageClear() {
            ...
            vm.invalidInputMessage = Object.assign({}, vm.invalidInputMessage, vm.defaultInvalidInputMessage);
        },
        ...
        invalidInputMessageExtract(error) {
            ...
            vm.invalidInputMessage = Object.assign({}, vm.invalidInputMessage, error.response.data[vm.invalidInputMessageJsonIndex]);
        }
    }
}